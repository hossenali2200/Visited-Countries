...
const Hero = ({ onSearch }) => {
  ...
  const handleSearch = () => {
    if (onSearch) {
      onSearch(searchTerm); // Pass the search term to the parent component's onSearch function
    }
  };
  return (
    <div>
          ...
          <div className="mx-auto flex flex-col items-center py-12 sm:py-24">
            <div className="w-11/12 sm:w-2/3 lg:flex justify-center items-center flex-col mb-5 sm:mb-10">
              ...
              <p className="mt-5 sm:mt-10 lg:w-10/12 text-gray-600 dark:text-gray-300 font-normal text-center text-xl">
                All Country Are Show in My Website.
              </p>
            </div>
            <div className="flex w-11/12 md:w-8/12 xl:w-6/12">
              <div className="flex rounded-md w-full">
                <input
                  ...
                  placeholder="keyword"
                />
                <button onClick={handleSearch} className="inline-flex items-center gap-2 bg-violet-700 text-white text-lg font-semibold py-3 px-6 rounded-r-md">
                  <span>Find</span>
                  <svg
